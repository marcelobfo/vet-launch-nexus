...
serve(async (req) => {
  ...
  try {
    ...
    try {
      // Use the configured webhook URL for code sending or default to log specific webhook
      const webhookUrl = company.whatsapp_webhook_url || 
                          'https://atendimento-creditar-n8n.stpanz.easypanel.host/webhook/vetplataformalog';
